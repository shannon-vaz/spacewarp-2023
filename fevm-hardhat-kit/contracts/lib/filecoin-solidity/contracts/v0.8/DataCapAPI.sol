...
library DataCapAPI {
    ...
    ) internal returns (BigInt memory) {
    ...
    ) internal returns (DataCapTypes.TransferReturn memory) {
        bytes memory raw_request = params.serialize();
    ...
    ) internal returns (DataCapTypes.TransferFromReturn memory) {
        bytes memory raw_request = params.serialize();
    ...
    function burn(
        DataCapTypes.BurnParams memory params
    ) internal returns (DataCapTypes.BurnReturn memory) {
        bytes memory raw_request = params.serialize();
    ...
    ) internal returns (DataCapTypes.BurnFromReturn memory) {
        bytes memory raw_request = params.serialize();
