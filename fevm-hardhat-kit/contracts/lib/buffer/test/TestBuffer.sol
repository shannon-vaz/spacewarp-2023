...
contract TestBuffer {
    ...
    function testBufferAppend() public pure {
        ...
        buf.append("world!");
        require(
            keccak256(abi.encodePacked(string(buf.buf))) ==
    ...
    function testBufferResizeAppendUint8() public pure {
        ...
        require(
            keccak256(abi.encodePacked(string(buf.buf))) ==
                keccak256(abi.encodePacked("01234567890123456789012345678901 ")),
            "Unexpected buffer contents."
        );
    }
    ...
    function testBufferResizeAppendBytes() public pure {
        ...
        require(
            keccak256(abi.encodePacked(string(buf.buf))) ==
                keccak256(abi.encodePacked("0123456789012345678901234567890123")),
            "Unexpected buffer contents."
        );
    }
